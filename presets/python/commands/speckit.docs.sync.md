---
description: Sync agent context files (AGENTS.md, CLAUDE.md, .github/copilot-instructions.md, GEMINI.md) from the installed agent-context.md template. Shows a diff for review before writing, keeping all agent context files in lockstep with the Python preset so every agent reads the same operating rules.
---
