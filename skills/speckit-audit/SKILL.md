---
name: speckit-audit
description: "Audit the codebase against the Python behavioral directives in the constitution. Runs the audit script, persists the JSON, summarizes findings by severity and section, and proposes prioritized fixes. Use when the user wants to check the codebase against the project's Python constitution."
---

# Speckit Audit

> This skill is generated from the Python preset command
> `presets/python/commands/speckit.audit.md` by `scripts/build-skills.py`.
